        ...
        <UploaderThumbContainer>
          <UploaderThumb 
            ...
            <UploaderField
              thumbnail
              type="file"
              onChange={(e:any) => handleUpload(e.target.files, "thumbnail")}/>
          </UploaderThumb>
          ...
          <Input style={{marginBottom:"0rem"}}>
              ...
              <Div inputTagContainer style={{marginBottom:"0rem"}}>
                ...
                <InputField
                  ...
                  type="text" 
                  ref={inputEl} 
                  onChange={(e:any) => setTagInputDef(e.target.value)}
                  value={tagInputDef}
          ...
          <Div checkContainer>
            <Div style={{marginBottom:"1rem"}} consentContainer>
              <CheckBox 
                ...
                onChange={() => setOpenForComments(!openForComments)}/>
              <p>Open for comments</p>
            </Div>
            <Div style={{marginBottom:"1rem"}} consentContainer>
              <CheckBox 
                checked={matureContents}  
                onChange={() => setMatureContents(!matureContents)}/>
              <p>Mature contents</p>
            </Div>
          </Div>
